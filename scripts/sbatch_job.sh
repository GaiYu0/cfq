...
python3 train.py --input-dir /work/yu_gai/cfq --output-dir /data/yu_gai/cfq --split $split --train-batch-size $batch_size --eval-batch-size 64 --num-workers 8 --seq-model $seq_model --seq-ninp 64 --nhead 16 --seq-nhid 256 --seq-nlayer 2 --gr-model rgcn --gr-ninp 64 --gr-nhid 64 --gr-nlayer 4 --w-pos $w_pos --gamma 1 --ntl-ninp 64 --ntl-nhid 64 --dropout 0.0 --optim Adam --lr 1e-3 --num-epochs 100
