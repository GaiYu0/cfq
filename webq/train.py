...
flags.DEFINE_string("tok_vocab_path", str(DATA_DIR / "webq" / "tok-vocab-webq-train.pickle"), "Token vocab path")
flags.DEFINE_string("rel_vocab_path", str(DATA_DIR / "webq" / "rel-vocab-webq-train.pickle"), "Rel. vocab path")
flags.DEFINE_string("cfq_data_path", str(DATA_DIR / "webq" / "data-webq-train.npz"), "Main CFQ data path")
flags.DEFINE_string("cfq_split_data_dir", str(DATA_DIR / "webq" / "splits"), "CFQ split data path directory.")
